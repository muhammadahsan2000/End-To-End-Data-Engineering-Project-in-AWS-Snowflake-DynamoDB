...
--Create integration object for external stage (integratioon obj connect s3 to snowflake )
create or replace storage integration s3_int
  type = external_stage
  storage_provider = s3
  enabled = true
  storage_aws_role_arn = 'arn:aws:iam::390402534240:role/Aws2Snowflake'
  storage_allowed_locations = ('s3://de-proj-weatherdata/snowflake/');
...
create or replace stage ext_csv_stage
  URL = 's3://de-proj-weatherdata/snowflake/'
